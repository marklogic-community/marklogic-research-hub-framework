        ...
        if (withResults) {
          reqOptions = {
            ...
            params: {
              ...
              'rs:options': req.query.options || config.namedOptions || 'all',
              'rs:transform': config.transform,
              'rs:workspaceId': query.workspace,
              'rs:workspaceRelevanceQuery':
                query.workspaceRelevanceQuery || false
            },
            headers: {
          ...
          reqOptions = {
            ...
            params: {
              format: 'json',
              start: withResults ? start : null,
              pageLength: withResults ? pageLength : null,
              view: withResults ? 'all' : 'facets',
              options: req.query.options || config.namedOptions || 'all'
            },
            headers: {
              'Content-Type': 'application/json',
              Accept: 'application/json'
