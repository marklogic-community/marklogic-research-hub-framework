...
var availableOptions = {
  ...
  allowAnonymousUsers: {
    default: false,
    variable: 'GROVE_ALLOW_ANONYMOUS_USERS',
    coerce: 'boolean'
  },
  anonymousUsername: {
    variable: 'ML_ANONYMOUS_USERNAME'
  },
  anonymousPassword: {
    variable: 'ML_ANONYMOUS_PASSWORD'
  },
  sparqlCacheRefreshInterval: {
    variable: 'SPARQL_CACHE_REFRESH_INTERVAL'
  },
