  ...
  return (
    <div className="col-md-9">
      <section id="top" className="card-list quick-section">
        ...
        <h1>
          <i className="fas fa-door-open" /> {jobopening.preferredName || id}
        </h1>
        <dl className="dl">
          <dt>Status</dt>
          <dd>
            <ul>{
              jobopening.reqStatus
            }</ul>
          </dd>
        </dl>
      </section>
...
class JobOpeningDetailView extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const jobopening = this.props.detail && this.props.detail;
          ...
          <Col md={1}>
            <Bookmark
              entity={{
                ...
                type: 'jobopening',
                label: jobopening.description || this.props.id
              }}
            />
          </Col>
          <Col md={11}>
...
JobOpeningDetailView.defaultProps = {
  template: ViewAsJson
};

JobOpeningDetailView.propTypes = {
...
export default JobOpeningDetailView;
