  ...
  return (
    <div className="col-md-9">
      <section id="top" className="card-list quick-section">
        ...
        <h1>
          <i className="fas fa-building" /> {department.preferredName || id}
        </h1>
        <dl className="dl">
          <dt>Location</dt>
...
class DepartmentDetailView extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const department = this.props.detail && this.props.detail;
          ...
          <Col md={1}>
            <Bookmark
              entity={{
                ...
                type: 'department',
                label: department.description || this.props.id
              }}
            />
          </Col>
          <Col md={11}>
...
DepartmentDetailView.defaultProps = {
  template: ViewAsJson
};
