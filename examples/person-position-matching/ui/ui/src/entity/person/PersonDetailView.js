  ...
  return (
    <div className="col-md-9">
      <section id="top" className="card-list quick-section">
        ...
        <h1>
          <i className="fas fa-user" /> {person.name || id}
        </h1>
        <dl className="dl">
          <dt>Birthdate</dt>
          ...
          <dd>
            <ul>{
              person.skill.map(skill => <li key={skill}>{ skill }</li>)
            }</ul>
          </dd>
        </dl>
      </section>
...
class PersonDetailView extends Component {
  ...
  render() {
    const person = this.props.detail && this.props.detail;
          ...
          <Col md={1}>
            <Bookmark
              entity={{
                ...
                type: 'person',
                label: person.name || this.props.id
              }}
            />
          </Col>
          <Col md={11}>
