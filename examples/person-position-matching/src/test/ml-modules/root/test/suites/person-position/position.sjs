...
const entityUris = [lib.URIS.position1, lib.URIS.position2];
const entities = {
    "entities":[
        {"predicate":"isRelevant", "value":"Definite", "entity":entityUris[0]},
        {"predicate":"isRelevant", "value":"Definite", "entity":entityUris[1]},
    ]
};
...
assertions.push(
    ...
    test.assertEqual(2, Object.keys(checkFullPostInsert.entities).length),  // CHECK FINAL ENTITIES LIST HAS 3 ENTRIES
