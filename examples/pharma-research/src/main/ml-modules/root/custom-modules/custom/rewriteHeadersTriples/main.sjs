...
function main(content, options) {
  ...
  // Rewrite header to remove multiple common facets, affiliations and lastModifiedDate
  let headers = headersPlugin.createHeaders(id, instance, options);

  // Rewrite triples based on commonFacets author preferred name
